...
Rather than generating advice from general knowledge alone, the agent grounds its reasoning in trusted, official sources: ESMA's Investor Corner for the EU, and FCA InvestSmart / MoneyHelper for the UK. It takes in a simple user profile (income, goals, timeline, risk tolerance, and region) and produces a recommendation with citations back to the source material, plus a plain-language explanation of the reasoning.
